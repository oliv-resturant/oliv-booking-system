                                  ...
                                  <SortableMenuItemWrapper key={item.id} id={item.id}>
                                    {({ ref, style, attributes, listeners }) => (
                                      <div
                                        ref={ref}
                                        style={style}
                                        className={`pl-8 sm:pl-20 pr-3 md:pr-6 py-3 flex items-center gap-2 md:gap-4 hover:bg-accent/30 transition-colors group ${index !== category.items.length - 1 ? 'border-b border-border/50' : ''
                                          }`}
                                      >
                                        {/* Drag Handle - Hide on mobile */}
                                        <button
                                  ...
                                  <SortableAddonItemWrapper key={item.id} id={item.id}>
                                    {({ ref, style, attributes, listeners }) => (
                                      <div
                                        ref={ref}
                                        style={style}
                                        className={`pl-8 sm:pl-20 pr-3 md:pr-6 py-3 flex items-center gap-2 md:gap-4 hover:bg-accent/30 transition-colors group ${index !== group.items.length - 1 ? 'border-b border-border/50' : ''
                                          }`}
                                      >
                                        {/* Drag Handle - Hide on mobile */}
                                        <button
